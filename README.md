...
Additionally, other types of machine learning analysis could also be helpful, such as random forest models or neural network models. I set up models for each of these types and their outcomes were only slightly improved, with an accuracy of 26.8% for the random forest model and 25.2% for the best of the neural networks.
